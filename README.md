...
- 🏆 **Notebook Demo:** You can use [predictor_example.ipynb](https://github.com/uni-medical/SAM-Med2D/blob/main/predictor_example.ipynb) to run it locally to view the prediction results generated by different prompts.<a target="_blank" href="https://colab.research.google.com/github/uni-medical/SAM-Med2D/blob/main/predictor_example.ipynb">
